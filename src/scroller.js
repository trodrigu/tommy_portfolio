...
var _user$project$Scroller$view = function (model) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'height', _1: '3000px'}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
...
var _user$project$Scroller$onModel = F2(
	function (model, animMsg) {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					style: A2(_mdgriffith$elm_style_animation$Animation$update, animMsg, model.style)
				}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Scroller$init = {
	ctor: '_Tuple2',
	_0: {
		style: _mdgriffith$elm_style_animation$Animation$style(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_mdgriffith$elm_style_animation$Animation$px(700)),
					_mdgriffith$elm_style_animation$Animation$height(
					_mdgriffith$elm_style_animation$Animation$px(90)),
					_mdgriffith$elm_style_animation$Animation$backgroundColor(
					A4(_elm_lang$core$Color$rgba, 75, 75, 75, 1))
				]))
	},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Scroller$scroll = _elm_lang$core$Native_Platform.incomingPort(
	'scroll',
	A3(
		...
		_elm_lang$core$Json_Decode$float));
var _user$project$Scroller$Model = function (a) {
	return {style: a};
};
var _user$project$Scroller$Animate = function (a) {
	return {ctor: 'Animate', _0: a};
};
var _user$project$Scroller$Shrink = {ctor: 'Shrink'};
var _user$project$Scroller$Header = function (a) {
	return {ctor: 'Header', _0: a};
};
var _user$project$Scroller$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_mdgriffith$elm_style_animation$Animation$subscription,
				_user$project$Scroller$Animate,
				_elm_lang$core$Native_List.fromArray(
					[model.style])),
				_user$project$Scroller$scroll(_user$project$Scroller$Header)
			]));
};
var _user$project$Scroller$Grow = {ctor: 'Grow'};
var _user$project$Scroller$update = F2(
				...
				return A3(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							400,
							_user$project$Scroller$update(_user$project$Scroller$Grow)),
							A2(
							_abrykajlo$elm_scroll$Scroll$onCrossUp,
							400,
							_user$project$Scroller$update(_user$project$Scroller$Shrink))
						]),
					_p0._0,
					model);
			case 'Grow':
...
var _user$project$Scroller$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Scroller$init, view: _user$project$Scroller$view, update: _user$project$Scroller$update, subscriptions: _user$project$Scroller$subscriptions})
};

var Elm = {};
Elm['Scroller'] = Elm['Scroller'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Scroller'], 'Scroller', typeof _user$project$Scroller$main === 'undefined' ? null : _user$project$Scroller$main);
